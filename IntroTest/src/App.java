...
"); 
    ...
    // Contoh 1: Penggunaan variable dan conditional 
(if-else) 
...
mataKuliah[i] + ": " + nilaiUjian[i]); 
        ...
        // Menghitung total dan rata-rata menggunakan 
for-each loop 
        int total = 0; 
...
nilaiUjian.length; 
        ...
        // Mencari nilai tertinggi dan terendah dengan 
while loop 
...
tertinggi); 
        ...
        // Menghitung jumlah nilai yang lulus (>=75) dengan 
do-while 
        int jumlahLulus = 0; 
        int idx = 0; 
        do { 
